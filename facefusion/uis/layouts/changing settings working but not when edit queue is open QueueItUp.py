...
def edit_queue():
    ...
    this doesnt read or update the settings_path ini file 
    settings_button2 = tk.Button(root, text="queueitup_settings", command=lambda: queueitup_settings(), font=custom_font)
...
def load_settings():
    ...
    if not os.path.exists(settings_path):
        ...
        print (f"Your ini file does not exist, creating {settings_path} but it will only have queueitup settings, FIX THAT")
...
def queueitup_settings():
    ...
    def save_and_close():
        ...
        # Check if keep_completed_jobs_var value changed from True to False
